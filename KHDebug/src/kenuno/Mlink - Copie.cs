...
namespace kenuno {
    public class Mlink {
        ...
        const uint tmp1 = (32 * 1024 * 1024) - (768) - (65536);
        const uint tmp2 = (32 * 1024 * 1024) - (768) - (65536) - (65536);
        const uint tmp3 = (32 * 1024 * 1024) - (768) - (65536) - (65536) - (65536);
        const uint tmp4 = (32 * 1024 * 1024) - (768) - (65536) - (65536) - (65536) - (65536);
        const uint tmp5 = (32 * 1024 * 1024) - (768) - (65536) - (65536) - (65536) - (65536) - (16 * 512);
        const uint tmp6 = (32 * 1024 * 1024) - (768) - (65536) - (65536) - (65536) - (65536) - (16 * 512) - (16 * 512);
        const uint tmp7 = (32 * 1024 * 1024) - (768) - (65536) - (65536) - (65536) - (65536) - (16 * 512) - (16 * 512) - (16 * 512);
        const uint tmp8 = (32 * 1024 * 1024) - (768) - (65536) - (65536) - (65536) - (65536) - (16 * 512) - (16 * 512) - (16 * 512) - (65536);
        const uint tmp9 = (32 * 1024 * 1024) - (768) - (65536) - (65536) - (65536) - (65536) - (16 * 512) - (16 * 512) - (16 * 512) - (65536) - (65536);
        const uint tmpa = (32 * 1024 * 1024) - (768) - (65536) - (65536) - (65536) - (65536) - (16 * 512) - (16 * 512) - (16 * 512) - (65536) - (65536) - (65536);
        const uint tmpb = (32 * 1024 * 1024) - (768) - (65536) - (65536) - (65536) - (65536) - (16 * 512) - (16 * 512) - (16 * 512) - (65536) - (65536) - (65536) - (65536);

        

        public static Matrix[] MatrixBuffer = new Matrix[5000];
        ...
        public void getMats(Stream fsMdlx, int cnt1, Stream fsMset, int cnt2, uint offMsetRxxx, float tick)
        {
            ...
            for (int w = 0; w < 64; w++) ee.ram[s2+w] = 0;

            if (true) {
                //if (cntPass == 0)
                    //ee.ram = File.ReadAllBytes(@"D:\Workspace\Home\khkh_xldM\khkh_xldMii\bin\Debug\test2.bin");
